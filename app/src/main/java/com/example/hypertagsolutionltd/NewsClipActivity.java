...
public class NewsClipActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_clip);

        indexIV = (ImageView) findViewById(R.id.indexIV);
        indexIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NewsClipActivity.this,IndexActivity.class);
                startActivity(i);
            }
        });
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(getBaseContext(), aList, R.layout.custome_newsclip_listview, from, to);
